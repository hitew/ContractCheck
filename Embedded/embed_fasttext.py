...
w2v =  FastText(sentences, vector_size=150, sg=1, min_count=1)
w2v.save("./Models/FastText/ft_model")
w2v=FastText.load("./Models/FastText/ft_model")
...
output_file = "./Embedded/ouput/FastText_vector.txt"
